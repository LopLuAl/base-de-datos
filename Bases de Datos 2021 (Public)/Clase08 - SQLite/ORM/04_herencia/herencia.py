...
class Persona(InheritableSQLObject):
    nombre = UnicodeCol(length=50, varchar=True, notNone=True)
    apellido = UnicodeCol(length=50, varchar=True, notNone=True)


class Profesor(Persona):
    titulo = UnicodeCol(length=160, varchar=True, notNone=True)


class Alumno(Persona):
    carrera = UnicodeCol(length=160, varchar=True, notNone=True)
    legajo = UnicodeCol(length=20, varchar=True, notNone=True)
