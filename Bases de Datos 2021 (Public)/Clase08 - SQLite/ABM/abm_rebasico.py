...
class ABM_rebasico:
    ...
    def conectar(self):
        ...
        '''
        try:
            self._conn = sqlite3.connect('../Chinook/Chinook_Sqlite_AutoIncrementPKs.sqlite')
    ...
    def borrar(self, datos):
        ...
        try:
            ...
            for artist, otro in datos:
                ...
                cur.execute("DELETE FROM Artist WHERE Name=?", (artist,))
        except:
            print(sys.exc_info()[1])
            error = True
        finally:
    ...
    def modificar(self, datos):
        ...
        try:
            ...
            for artist, new_artist in datos:
                ...
                cur.execute("UPDATE Artist SET Name=? WHERE Name=?", (new_artist, artist))
        except:
            print(sys.exc_info()[1])
            error = True
        finally:
    ...
    def limpiar(self, datos):
        ...
        try:
            ...
            for artist, otro in datos:
                ...
                cur.execute("DELETE FROM Artist WHERE Name=? OR Name=?", (artist, otro))
        except:
            print(sys.exc_info()[1])
            error = True
        finally:
