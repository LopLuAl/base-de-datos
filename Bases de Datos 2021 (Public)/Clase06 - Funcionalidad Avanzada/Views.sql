...
select view_all_albums.*, Artist.ArtistId 
from view_all_albums
join Artist on (Artist.Name = view_all_albums.Artist)
where Tracks > 10 and view_all_albums.Artist like 'A%';