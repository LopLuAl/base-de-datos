...
ORDER BY LENGTH(Artist.Name) DESC, Artist.Name ASC;
...
INSERT INTO Album (ArtistId, Title) VALUES (276, 'Mondo Bizarro');
INSERT INTO Album (ArtistId, Title) VALUES (276, 'Adios Amigos!');

UPDATE Artist SET Name = 'Los Ramones' WHERE ArtistId = 276;
